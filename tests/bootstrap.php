<?php
/**
 * Tmwp_listCategories Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_tmwp_list_categories_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/tmwp-list-categories.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_tmwp_list_categories_plugin' );
